...
if ($process!="adm") {
	...
	include "inc/$process.php";
		...
		header("Location: sozluk.php?process=word&q=Anka+Sözlük");
		}	
	}
} else {
...
$bitir = mtime();
echo "<br><br><br><center>copyright &copy; 2015 <a href=sozluk.php?process=word&q=anka+Sözlük+entertainment target=main><font size=1>anka Sözlük entertaintment</font></a>";

echo "
<hr>
<div class='copyright' align='center'><font size=1><a href=sozluk.php?process=word&q=anka+Sözlük target=main><font size=1>anka Sözlük</font></a> | <a href=http://www.ankasozluk.com/xml/today.xml target=main><font size=1>anka Sözlük RSS</font></a> | Kuruluş : 10.11.2009<br></DIV><br>
anka Sözlükte olan herşey yalan olabilir. anka sözlük içeriği herhangi bir ön denetimden geçmeksiniz olduğu gibi yayınlanır ve doğrulu garanti edilmemektedir. <br>her yazar kendi bacağından asılır, kimse bizi bağlamaz. sözlükte bulunan her satır yazarlarına aittir. araklanması yada kaynak gösterilmeden yayınlanması yasaktır. kaynak gösterilerek ticari olmayan yerlerde yayınlanabilir.<br>
";
}
