...
switch(languageCode){
	case "en":	/* English */
		var monthArray = ['ocak','subat','mart','nisan','mayis','haziran','temmuz','agustos','eylul','ekim','kasim','aralik'];
		var monthArrayShort = ['oca','sub','mar','nis','may','haz','tem','agu','eyl','eki','kas','ara'];
		var dayArray = ['pts','sal','car','per','cum','ctesi','pazar'];
		var weekString = 'hafta';
		var todayString = 'bugun';
		break;
	case "ge":	/* German */
