...
function e(f,i,an)
{
        with(document)
        {
          write('<div align=right><table id=m'+i+' style="visibility:hidden"><tr><td class=ei><a name="cid'+i+'"></a><a href="#cid" onclick="copyid('+i+','+f+');">#'+i+'</a></td>');
                  a("javascript:od('sozluk.php?process=yorum&deger=arti&id="+i+"')",":)","$ukela!");
                  a("javascript:od('sozluk.php?process=yorum&deger=enteresan&id="+i+"')",":O","enteresan");
                  a("javascript:od('sozluk.php?process=yorum&deger=eksi&id="+i+"');",":(","oeehh");
				  a("javascript:od('sozluk.php?process=yorum&deger=sy&id="+i+"');","yorumla","sadece yorum yapmak icin");
				  a("javascript:od('sozluk.php?process=yorum&deger=sy&id="+i+"');","fb","facebookda paylas");
...
function e_mod(f,i,an,sr)
{
        with(document)
        {
          write('<div align=right><table id=m'+i+' style="visibility:hidden"><tr><td class=ei><a name="cid'+i+'"></a><a href="#cid" onclick="copyid('+i+','+f+');">#'+i+'</a></td>');
				  ...
				  a("javascript:od('sozluk.php?process=yorum&deger=eksi&id="+i+"');",":(","oeehh");
				a("javascript:od('sozluk.php?process=yorum&deger=sy&id="+i+"');","yorumla","sadece yorum yapmak icin");
a("javascript:od('http://www.facebook.com/sharer.php?u=http://www.iticusozluk.com/sozluk.php?process=eid%26eid="+i+"');","fb","facebookda paylas");
                  a("javascript:location.href='sozluk.php?process=privmsg&islem=yenimsj&gkime="+an+"&gkonu="+i+" nolu entry';","/msj","mesaj at");
...
function copyid(id,f) 
{
	...
	var u = "http://www.18martsozluk.net/"+id+".html";
