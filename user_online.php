<?
   include ("config.php"); // veritabanina baglanti kodlari yer alacak
   ...
   mysql_close();
   if($user == 1) {
       print("<center><font color=blue size=1>$user</font><font size=1> Kisi Online</font>\n");
   } else {
       print("<font color=blue size=1>$user</font><font size=1> Kisi Online</font>\n");
   }
