...
<meta name="keywords" content="<? echo "$site_ad, $site_ad nedir, $site_ad hakkında bilgiler, $site_ad oku, $site_ad bilgi, $site_ad anlamı nedir, $site_ad anlami, $site_ad ne demek, $site_ad ne oluyor - $sitename"; ?>">
<meta name="description" content="<? echo "$site_ad, $site_ad anlamı, $site_ad tanımı ve $site_ad hakkında ayrıntılı bilgiler. - $sitename"; ?>">
