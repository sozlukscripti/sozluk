<?
if ($verified_kat != "admin" and $verified_kat != "mod" and $verified_kat != "gammaz" $verified_kat != "modust") {
...
<table width=\"443\" border=\"0\">
  <tr>
    <td width=\"154\">Baslik</td>
    <td width=\"10\">:</td>
    <td width=\"265\"><input name=\"baslik\" type=\"text\" id=\"baslik\" value=\"$baslik\"></td>
  </tr>
  <tr>
    <td>Tasinacak baslik </td>
    <td>:</td>
