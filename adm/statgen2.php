...
<table align=center width=\"400\" border=\"0\" cellSpacing=0 cellPadding=0>
  <tr>
    <td width=\"300\"><a class=div><b>Toplam Başlık Sayısı</td>
    <td width=\"4\">:</td>
    <td width=\"271\">$baslik</td>
  </tr>
  <tr>
    <td><a class=div><b>Toplam Entry Sayısı</a></td>
    <td>:</td>
    <td>$entry</td>
  </tr>
  <tr>
    <td><a class=div><b>Silinen Başlık Sayısı</td>
    <td>:</td>
    <td>bilinmiyor</td>
  </tr>
  <tr>
    <td><a class=div><b>Silinen Entry Sayısı</td>
    <td>:</td>
    <td>$silentry</td>
  </tr>
  <tr>
    <td><a class=div><b>Toplam Başlık Gösterimi</td>
    <td>:</td>
    <td>$hit</td>
  </tr>
  <tr>
  ...
  <tr>
    <td><a class=div><b>Pilot Yazar Sayısı</td>
    <td>:</td>
    <td>$pilot</td>
  </tr>
  <tr>
    <td><a class=div><b>Moderatör Sayısı</td>
    <td>:</td>
    <td>$mod</td>
  </tr>
  <tr>
    <td><a class=div><b>Operatör Sayısı</td>
    <td>:</td>
    <td>0</td>
  </tr>
  <tr>
  ...
  <tr>
    <td><a class=div><b>En hit başlık</td>
    <td>:</td>
  ...
  <tr>
    <td><a class=div>Yazar başına düşen ortalama başlık sayısı</td>
    <td>:</td>
    <td>$ortbaslik</td>
  </tr>
  <tr>
    <td><a class=div>Yazar başına düşen ortalama entry sayısı</td>
    <td>:</td>
    <td>$ortentry</td>
  </tr>
</table> <br>
