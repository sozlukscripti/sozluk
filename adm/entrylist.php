...
<?
$nick =@$_POST["nick"];
echo "<strong>$nick nickine ait son 100 entry asaðýda listelendi.</strong><br><br>";
$sorgu = "SELECT id,sira,mesaj,yazar,tarih FROM mesajciklar WHERE yazar = '$nick' ORDER by `id` desc LIMIT 0,100";
...
echo "Bu mal hiç entry girmemiþ daha.";
}
