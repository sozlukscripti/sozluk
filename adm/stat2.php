...
$id=$kayit["id"];
if ($hit > $tophit and $gbaslik != "sozluk yazim kurallari" and $gbaslik != "sozluk hakkinda en cok sorulan sorular" and $gbaslik != "h" and $gbaslik != "eksi sozluk") {
$tophit = $hit;
$enhit = $id;
}
}
...
$sor3 = mysql_query("select id from user WHERE yetki = 'mod' or yetki = 'modust'");
...
echo "<center><b>Stat ($tarih) apdeytýd</b></center>";
//burasi modlog icin
