...
<b>
<div style="margin:35px;margin-bottom:0px;">böyle bir þey (<? if ($baslik) { echo "$baslik"; }?>) yok. ama olabilir de.</b></div>
</br>
</br>
</br>
  ...
  <INPUT class=inp maxLength=80 SIZE=60 name=baslik value="<? if ($baslik) { echo "$baslik\" readonly"; }?>">
    ...
    <tr>
      ...
      <td colspan="2">
        ...
        "<? if ($baslik) { echo "$baslik"; }?>" hakkýnda kafanýzda bir taným veya verebileceginiz bir örnek varsa eklemekten çekinmeyin:
