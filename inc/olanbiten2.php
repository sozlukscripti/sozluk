...
if ($page >= 2) {
$oncekisayfa = $page-1;
echo "<a class=but href=\"sozluk.php?process=olanbiten&sayfa=$oncekisayfa\"><font face=verdana size=1><b><<</b></font></a> ";
}
...
$bisonraki = $page+1;
echo " <a class=but href=\"sozluk.php?process=olanbiten&sayfa=$bisonraki\"><font face=verdana size=1><b>>></b></font></a>";
}
}
...
<td width='100' style='background-color:#B4E8AC;  padding:8px;'>
<a href='sozluk.php?process=ben&kim=$yazar'><b>$yazar</b></a>
</td>

<td style='background-color:#DFF5DC; padding:8px;'>
<div style=''>
<b>$konu</b> <br/>
$aciklama";
