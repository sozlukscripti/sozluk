...
session_register("verified_user", "sid", "kat", "verified_kat", "durum");
        ...
        echo "
        <center><font size=2><img src=images/unlem.gif> $sitename kurallarýna uymadýgýnýz için hesabýnýz kapatýlmýþtýr.</center>
        <META HTTP-EQUIV=\"REFRESH\" CONTENT=\"10;URL=sozluk.php?process=master\">";
        die;
        }
        else {
echo "
<center><font size=2><img src=images/unlem.gif> Yanlýþ kullanýcý adý ya da þifre</center>
