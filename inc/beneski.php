...
$silsebep=mysql_query("select silsebep from mesajciklar where yazar='$nick' group by silsebep order by yazar desc limit 10");
 ...
 echo "<form action='' method='GET'><input type='hidden' name='process' value='ben'><input type='text' name='kim' size='13' class='input'> <input type='submit' value='getir' class='but'> <input type='button' value='kapat' onclick='window.close();' class=but> ";
 if ($verified_kat == "admin" or $verified_kat == "mod") {
 echo " <a class='but' target='main' href='sozluk.php?process=adm&islem=kullanici&update=ok&gnick=".$_GET['kim']."'>&nbsp;edit&nbsp;</a>"; 
 }
 ...
 echo "<b><a href='sozluk.php?process=word&q=$nick' target=main>$nick</a> </b> <br>";
    ...
    echo ("birinci nesil anka sözlük ");
        ...
        else if ($regtarih>"2015/06/01 17:10" and  $regtarih<"2016/01/01 17:11") {
  ...
  if ($durum=="on") {
   ...
   echo "azizi";
    ...
    else if ($kacmesaj>10000 and $kacmesaj<=20000) {

   echo "efendisi";
   } 
    else if ($kacmesaj>20000 and $kacmesaj<=30000) {

   echo "evlat";
   } 
    else if ($kacmesaj>30000 and $kacmesaj<=40000) {

   echo "kardeþ";
   } 
    else if ($kacmesaj>40000 and $kacmesaj<=50000) {

   echo "erdemlisi";
   }
    else if ($kacmesaj>50000 and $kacmesaj<=60000) {

   echo "yücesi";
   }
    else if ($kacmesaj>60000 and $kacmesaj<=70000) {

   echo "çýrak";
   }
    else if ($kacmesaj>70000 and $kacmesaj<=80000) {

   echo "kalfa";
   }
    else if ($kacmesaj>100000) {
  ...
  echo "<br><font size=\"1\" color=\"gray\">$ileti </font><center>";
...
echo"<table width=\"100%\" border=0 cellpadding=0 cellspacing=0>"
  ...
  . "<td>"
  . "<br>"
  . "<script language=\"javascript\">b(\"main\",\"sozluk.php?process=yazar&yazar=$_GET[kim]\",\"entry'ler\",\"tanýmlarý\")</script><script language=\"javascript\">b(\"main\",\"sozluk.php?process=inbox&gkime=$_GET[kim]\",\"msj\",\"mesaj yolla\")</script><script language=\"javascript\">b(\"main\",\"sozluk.php?process=arkadasekle&n=$_GET[kim]\",\"panpa\",\"panpa listeme ekle\")</script><script language=\"javascript\">b(\"main\",\"sozluk.php?process=dusmanekle&n=$_GET[kim]\",\"bloke\",\"bloke listeme ekle\")</script>"
  . "</table>"
  . "</td>"
  . "</tr>"
 ."";

 echo "<table cellpadding=0 cellspacing=0 border=0><tr><td width='100%'><hr></td><td><small>";
...
$sayginlik = "saygýsýz";
 ...
 echo "<div class=infosec onclick=\"return sc('sb_2')\"> <font size='1'>&nbsp; þukelata gibi entryleri</font></div><div style=\"display:none\" id=\"sb_gn\"></div>";
 ...
 echo "<div class=infosec onclick=\"return sc('sb_3')\"> <font size='1'>&nbsp; çükülenmiþ entryleri</font></div><div style=\"display:none\" id=\"sb_gn\"></div>";
 ...
 echo "<div class=infosec onclick=\"return sc('sb_4')\"> <font size='1'>&nbsp; enteresan entryleri</font></div><div style=\"display:none\" id=\"sb_gn\"></div>";
