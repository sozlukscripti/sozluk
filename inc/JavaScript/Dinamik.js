...
document.getElementById('sonuc').innerHTML='<img src="Resimler/loading.gif" /></br>Kontrol Ediliyor...'
	xmlHttp=ajax(); 
	if (xmlHttp==null) 
	{
		alert ('Tarayýcýnýz Ajax Desteklemiyor!');
		return;
	}
   ...
   var nick = document.getElementById('nick').value; 
    ...
    var url='Fonksiyonlar/uyeadikontrol.php'; 
