...
echo "<div><a href='sozluk.php?process=inbox&gkime=$oku[kim]'>$oku[kim]</a> <a href='sozluk.php?process=rehbersil&num=1&kim=$oku[kim]' title='listemden çýksýn'>(-)</a> $durum</div>";
}
?>
</fieldset>
</div>
