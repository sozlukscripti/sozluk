...
if ($verified_kat == "admin" or $verified_kat == "modust" or $verified_kat == "mod") //baslýk silmeyi sadece ustduzeymodlar yapacak
...
if (!$q) {
echo "<div class=dash><center> ne aradýn yavrum..";
exit;
}
...
echo "<div class=dash align='left'><font size=4><a name='$q'>$q</a></font><br><font size=2>böyle bir þey ($q) yok. ama olabilir de. <br> $yonlendir2 </font></div><br>";
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
if ($verified_durum = "on") 
echo "<p class=div1>ukte veren: $yazar ($gun/$ay/$yil)<br><br></p>"; 
if ($verified_durum == "on") 
...
<input type=submit class=but name=ac value=\"ukteyi doldurayim\"> 
</form> 
"; 
...
<input type=hidden name=\"okword\" value=\"$q\"> 
<input type=hidden name=okmsj value=ok> 
<input type=submit class=but name=ac value=\"ukte vereceðim\"> 
</form> 
"; 
} 
...
echo "
<p><center><b>sikimsonik entry'ni girdin aferin!</b><br>
<a href=\"sozluk.php?process=word&q=$baslik$gostersayfa\">devam!</a>
</font></a></b></center></p><br><br>
<META HTTP-EQUIV=\"REFRESH\" CONTENT=\"1;URL=sozluk.php?process=word&q=$baslik$gostersayfa\">
...
if ($sayfa > 1 or $sayfa) {
if ($sayfa != 1)
echo "<a class=but href=\"sozluk.php?process=word&q=$q&sayfa=$linksayfa\"><font face=verdana size=1><b><<</b></font></a> ";
}
}
...
$sayac = 0;
$sayacsorgu = "select * from mesajciklar WHERE `yazar`='$verified_user' and `statu` = 'silindi' ";
$sayacsorgulama = mysql_query($sayacsorgu);
$kac = mysql_num_rows($sayacsorgulama);
echo "
";
$olanbiten = mysql_num_rows(mysql_query("SELECT * FROM user WHERE nick='$verified_user' and olanbiten='1'"));
if($verified_user) {
echo "


<DIV class=right id=panel style=\"FLOAT: right\">
...
<TABLE border=\"0\" cellpadding=\"3\" cellspacing=\"1\" class=\"sagtable\">

<TR>";
if ($okunmayan > 0) {
	echo "<TD class='yenimsj' id='pmsg' style='width: 158px; height: 15px;'><a href='sozluk.php?process=inbox' style='font-size:12px;'>inbox ($okunmayan)</a></TD>";
}else {
	echo "<TD class='pi' id='pmsg' style='width: 158px; height: 15px;'><a href='sozluk.php?process=inbox' style='font-size:12px;'>inbox</a></TD>";
}
echo "
</TR>

<TR>
<TD class='pi' id='pmsg' style='width: 158px; height: 15px;'><a href='sozluk.php?process=copkutu' style='font-size:12px;'>çöplük</a></TD>
</TR>
<TR>";
if ($olanbiten > 0) {
	echo "<TD class='yenimsj' id='pmsg' style='width: 158px; height: 15px;'><a href='sozluk.php?process=olanbiten' style='font-size:12px;'>olan biten</a></TD>";
}else {
	echo "<TD class='pi' id='pmsg' style='width: 158px; height: 15px;'><a href='sozluk.php?process=olanbiten' style='font-size:12px;'>olan biten</a></TD>";
}
echo "</TR>
<TR>
<TD class='pi' id='pmsg' style='width: 158px; height: 15px;'><a href='sozluk.php?process=temalar' style='font-size:12px;'>temalar</a></TD>
</TR>

<TR>";
$basliktakiptemi = mysql_num_rows(mysql_query("SELECT * FROM basliktakip WHERE yazar='$verified_user' and baslik='$baslik'"));
if ($verified_user) {
if ($basliktakiptemi > 0) {
	echo "<TD class='pi' id='pmsg' style='width: 158px; height: 15px;'><a href='sozluk.php?process=basliktakipkaldir&id=$id' style='font-size:12px;'>-</a> <a href='sozluk.php?process=basliktakip' style='font-size:12px;'>baþlýk takip</a></TD>";
}else {
	echo "<TD class='pi' id='pmsg' style='width: 158px; height: 15px;'><a href='sozluk.php?process=basliktakipekle&id=$id' style='font-size:12px;'>+</a> <a href='sozluk.php?process=basliktakip' style='font-size:12px;'>baþlýk takip</a></TD>";
}

echo "</TR>
<TR>
<TD class='pi' id='pmsg' style='width: 158px; height: 15px;'><a href='sozluk.php?process=panpa' style='font-size:12px;'>panpa</a> <font color=\"#A8A8A8\">|</font> <a href='sozluk.php?process=bloke' style='font-size:12px;'>bloke
</br></a></TD>


</TR>
<TR>
<TD class='pi' id='pmsg' style='width: 158px; height: 15px;'><a href='sozluk.php?process=cevrimpici' style='font-size:12px;'>çevrimiçi
</br></a></TD>
...
$ispit = "<a href=sozluk.php?process=ispit&id=$id><font size=1>[ispitle]</a>";
else
$ispit = "";
...
$oylama = " <a href=\"javascript:od('sozluk.php?process=arti&id=$id',300,200)\">:)</a> | <a href=\"javascript:od('sozluk.php?process=enteresan&id=$id',300,200)\">:0</a> | </font> ";
else
$oylama = "";
if ($yazar != $verified_user and $verified_user)
...
else if ($verified_kat == "admin" or $verified_kat == "mod" or $verified_kat == "modust")  $msg = "<script language=\"javascript\">e_mod(252,$id,'$yazar',$sira);</SCRIPT>";
...
echo "
  ...
  echo "
  <DIV align=right>$ispit <div class=\"aul\"><font>(<A
...
if ($linksayfa <= $goster)
echo " <a class=but href=\"sozluk.php?process=word&q=$q&sayfa=$linksayfa\"><font face=verdana size=1><b>>></b></font></a><br><br>";
}
...
<div style="text-align: center;"><font size="1">&nbsp; &copy; 2015 - <a href="http://ankasozluk.com/" target="_blank">anka sözlük</a> </font></br><font size="1" color="gray"> '<? print("$q");?>' baþlýðý yazarlara aittir,</br> eðer ki bu pi&ccedil;&ouml;zlere itirazýn varsa,ya þimdi konuþ,yada sonsuza &nbsp;kadar sus. </br>ayrýca bu ortam ve yazýlanlar hatta ve hatta g&ouml;rm&uuml;þ olduðun herþey,yazarlara aittir.. </br>burada herþey olduðu gibidir,olmasý gerektiði gibi deðil.. </br>kutsal anka&ccedil;</font></div>
<center><a href="anarþizm.html"><img src="http://ankasozluk.com/images/anarchism.png" width="16" height="16" alt="" /></a> <a href="sansür.html"><img src="http://ankasozluk.com/images/censored.png" width="14" height="14" alt="" /></a></center>
</body>
</html>
<?exit;
cache_save('word');
