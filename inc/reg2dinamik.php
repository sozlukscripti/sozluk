<fieldset><legend>Adým 2</legend>
<SCRIPT src="images/sozluk.js" type=text/javascript></SCRIPT>
<SCRIPT src="images/Dinamik.js" type=text/javascript></SCRIPT>
<?
include "config.php";
...
<body>
<span class="link"><B>Yazarlýk baþvurunuzun tamamlanmasý için aþagýdaki boþluklarý doldurunuz. </B>:<BR>
<BR>
</span>
...
type=hidden value=y name=submit>
  ...
  <table width="580" border="0">
    ...
    <tr>
      <td colspan="3">(Türkçe karakterler ve özel karakterler olan @'^,.~ gibi karakterler içeremez.) Seçilen nick bir daha deðiþtirilemez!</td>
    </tr>
      <?
...
echo "<td colspan=\"3\">Mail adresiniz. Þifrenizi unutmanýz veya kaybetmeniz halinde iletiþim den bizimle irtibata geçin ki yeni þifrenizi hemen verelim.</td>";
    ...
    <tr>
      <td colspan="3"><img src="images/unlem.gif" width="12" height="12"> Sallasanda farketmez.</td>
    </tr>
    <tr>
      <td><strong>Doðum Günün</strong></td>
      <td>:</td>
...
selected>
  ...
  <p>Üye olmak istediðine emin misin?
    <input type=submit class=but value="Evet eminim!">
</FORM>
