...
$sorgu .= " VALUES ";
$sorgu .= "('$id','$verified_user','$yazar','1')";
mysql_query($sorgu);
echo "



<div class=dash><center><b><img src=images/unlem.gif> (+) Oyunuz eklendi.<br><input type='button' value='saygi duydum' onclick='window.close();' class=but>";
}
###############################
