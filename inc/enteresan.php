...
$sorgu .= " VALUES ";
$sorgu .= "('$id','$verified_user','$yazar','2')";
mysql_query($sorgu);
echo "<div class=dash><center><b><img src=images/unlem.gif> Enteresan oyunuz eklendi.<br><input type='button' value='ne diyorsam o' onclick='window.close();' class=but>";
}
###############################
